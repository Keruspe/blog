...
It's available [there](https://www.imagination-land.org/files/gpaste/gpaste-3.6.tar.xz), get it while it's hot!

This release is only compatible with GNOME 3.9.90 and above. if you're still using an older version, please check
[GPaste 3.2](https://www.imagination-land.org/posts/2013-10-16-gpaste-3.2-released.html).
