---
title: GPaste 50.8 released
author: Marc-Antoine Perennou
tags: GPaste, release, clipboard, gnome
---

It's available [there](https://www.imagination-land.org/files/gpaste/GPaste-50.8.tar.xz), get it while it's hot!
...
This is a maintenance release, fixing history switching in the graphical tool.

- Fix selecting a history in the sidebar doing nothing, and, when a history's context menu was open, switching to that one instead of the one clicked
