...
It's available [there](https://www.imagination-land.org/files/gpaste/gpaste-3.5.tar.xz), get it while it's hot!

This release is only compatible with GNOME 3.9.90 and above. if you're still using an older version, please check
[GPaste 3.1](https://www.imagination-land.org/posts/2013-09-23-gpaste-3.1-released.html).
